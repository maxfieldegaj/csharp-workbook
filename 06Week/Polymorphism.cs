...
public class Program
{
	...
	{
        Shape rectangle = new Rectangle(34, 12); // Upcasting
        Rectangle cRectangle = rectangle as Rectangle; // Downcasting
...
public class Triangle : Shape
{
    ...
    public override int Perimeter() => Height + Width + Diagonal;
}